  ...
  onKeyDown = (e) => {
    if(this.props.searchData.length > 0){
      if(e.keyCode === 13){
        ...
        this.getCachedClickHanlder(value['renderInNaver']['latitude'], value['renderInNaver']['longitude'])()
      }
      ...
      <StyledSearchResult display={this.props.searchData.length > 0}>
      {
        this.props.searchData.map((value,i) => {
          return(
            ...
            onClick={this.getCachedClickHanlder(value['renderInNaver']['latitude'], value['renderInNaver']['longitude'])}>
              <div>
    ...
    return(
      <SearchContainer>
        <InputContainer>
          ...
          <StyledInput type="text" name='searchText' onChange={this.onChange} value={this.state.searchText} onKeyDown={this.onKeyDown}/> 
          <img src='/static/search.svg' alt="search-image" onClick={this.onClick}/>
        </InputContainer>
